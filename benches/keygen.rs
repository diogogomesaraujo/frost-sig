...
fn keygen_benchmark(c: &mut Criterion) {
    ...
    generate_keygen_values(&mut group, &FrostState::new(5, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(10, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(15, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(20, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(25, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(30, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(35, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(40, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(45, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 5)).unwrap();
    group.finish();
    ...
    generate_keygen_values(&mut group, &FrostState::new(50, 5)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 10)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 15)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 20)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 25)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 30)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 35)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 40)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 45)).unwrap();
    generate_keygen_values(&mut group, &FrostState::new(50, 50)).unwrap();
    group.finish();
}
