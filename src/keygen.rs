...
pub fn test_keygen() {
    ...
    for _ in 0..1000 {
        ...
        let share_from_3_to_1 =
            round_2::create_share_for(&state, &participant_3, &participant_1.id);
        let share_from_2_to_1 =
            round_2::create_share_for(&state, &participant_2, &participant_1.id);
